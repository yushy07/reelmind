...
[![Release](https://img.shields.io/badge/Release-v0.4.1-8b5cf6?style=for-the-badge&logo=github)](https://github.com/yushy07/reelmind/releases/tag/v0.4.1)
...
1. Download **`REELMIND.Setup.0.4.1.exe`** from the [v0.4.1 Release](https://github.com/yushy07/reelmind/releases/tag/v0.4.1).
