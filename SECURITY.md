...
The installer is unsigned. v0.3.0 is a personal-use prerelease published while real Hindi/Hinglish, Japanese, and mixed-language evaluation remains incomplete; do not treat it as a stable-quality guarantee. Before a stable release, complete real-media validation, signing if desired, and the bundled dependencies' license/source-distribution requirements described in THIRD_PARTY.md. Do not bundle personal credentials or app data in a release.
