...
export async function render(runtime:string,source:string,plan:EditPlan,output:string,work:string,quality:string,hardware:{nvenc:boolean;cpuThreads:number},signal:AbortSignal,report:(n:number)=>void){
